...
#Creates 4 line plots that are placed in a 2 by 2 grid 
par(mfcol=c(2,2))

with(data3,plot(Time2,Global_active_power,ylab="Global Active Power",xlab='',type="l"))
...
with(data3,plot(Time2,Global_reactive_power,xlab='datetime',type="l"))
